...
shift_theta = linspace(0.1,30,10);
...
figure
plot(shift_theta*theta_3dB,opt_arr,'k-^','LineWidth',0.7)
%hold on
%plot(shift_theta,cbf_arr)
hold on
plot(shift_theta*theta_3dB,mvdr_arr,'k--o','LineWidth',0.7)
hold on
plot(shift_theta*theta_3dB,mpdr_arr,'k--x','LineWidth',0.7)

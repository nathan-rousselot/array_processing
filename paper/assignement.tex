...
\begin{equation}
    \mathcal{L}(\mathbf{w},\lambda,\mu) = \frac{\left(\hat{\mathbf{R}+\mu \mathbf{I}}\right)^{-1}\mathbf{a}_0}{\mathbf{a}_0^H\left(\hat{\mathbf{R}+\mu \mathbf{I}}\right)^{-1}\mathbf{a}_0}
\end{equation}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{width=0.4\textwidth}
        \input{figures/robust_k_sinr}
        \caption{SINR in function of K}
        \label{fig:robust_k_sinr}
    \end{subfigure}\hspace{0.09\linewidth}
    \begin{subfigure}[b]{width=0.4\textwidth}
        \input{figures/robust_k_awn}
        \caption{$A_{WN}$ in function of K}
        \label{fig:robust_k_awn}
    \end{subfigure}
    \caption{Convergence in function of K of MVDR and MPDR.}
